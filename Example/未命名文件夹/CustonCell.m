...
- (void)setModel:(PresentModel *)model
{
    ...
    if ([model.giftImageName isEqualToString:@"XSJ抛媚眼"]) {
        self.gift.image = [UIImage imageNamed:@"XSJ抛媚眼"];
    } else {
        
        [self.gift sd_setImageWithURL:[NSURL URLWithString:model.giftImageName]];
    }
}
